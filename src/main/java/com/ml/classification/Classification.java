...
import static util.TreePrinter.visualize;
...
public class Classification {
    public static void main(String args[]) {
        try {
            ...
            classify(data, tree);
            Evaluation eval_roc = evaluate(data);
    ...
    private static Evaluation evaluate(Instances data) throws Exception {
    ...
    private static void setupTrainingData(Instances data) throws Exception {
